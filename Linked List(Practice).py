...
You can ignore the outdated instructions about creating an account and
"fork"ing the code. On Pytwiddle, there is no need to do either. You can
immediately get started editing and running the script.

Back to the course: https://skl.sh/3BVvGyD
Back to the resources webpage: https://alvinwan.com/datastructures101
"""
